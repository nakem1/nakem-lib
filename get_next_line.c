...
/*   Updated: 2021/02/14 18:37:36 by lmurray          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** 		Function:         char		*ft_allocate_join();
**
** 		Description:      helper function for ft_strjoin ().
** First, it allocates the string, then adds s1 and s2 to string.
*/
...
**
** 		Description:      concantenate two strings and return
*/
...
char		*ft_strjoin(char const *s1, char const *s2)
{
	...
	if ((str = ft_allocate_join(n, m, s1, s2)))
		str[n + m] = '\0';
	return (str);
}
